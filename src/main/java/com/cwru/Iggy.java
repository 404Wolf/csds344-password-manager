...
public class Iggy {
    ...
    private static SecretKeySpec generateSecretKey(String passcode, byte[] salt) throws NoSuchAlgorithmException, InvalidKeySpecException {
    ...
    private static void addPassword(String label, String password) throws Exception {
        ...
        Files.write(Paths.get(FILE_NAME), fileContent.getBytes(), java.nio.file.StandardOpenOption.APPEND);
    }
